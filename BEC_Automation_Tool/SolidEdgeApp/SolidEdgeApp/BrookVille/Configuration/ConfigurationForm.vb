...
Public Class ConfigurationForm
    ...
    Public Sub InitializeConfigData()
        Try
            ...
            '26th Oct 2024
            'txtVirtualAslDirPath.Text = Config.configObj.virtualAssemblyOutputDirec
            ...
            '14th october 2024
            txtHelpDocumentDirPath.Text = Config.configObj.HelpDocDir  ' AppDomain.CurrentDomain.BaseDirectory + "Help"
    ...
    Private Sub btnRawMaterialEstimationReportDirPath_Click(sender As Object, e As EventArgs) Handles btnHelpDocumentDirPath.Click
        '11th october 2024
        BrowseDirPath(txtHelpDocumentDirPath)
    End Sub
    ...
    '    BrowseDirPath(txtVirtualAslDirPath)
    'End Sub
    ...
    Public Sub SaveBtnData()
        ...
        Else
            ...
            '26th Oct 2024
            'Config.configObj.virtualAssemblyOutputDirec = txtVirtualAslDirPath.Text
            ...
            Config.configObj.rawMaterialEstimationReportDirPath = txtHelpDocumentDirPath.Text
            ...
            '11th october 2024
            Config.configObj.HelpDocDir = txtHelpDocumentDirPath.Text
    ...
    Private Sub SaveHelpDocs()

        Dim sourceFolder As String = AppDomain.CurrentDomain.BaseDirectory + "Help" 'C : \Program Files (x86)\Technosoft\BEC Automation\Help

        ' Destination folder where PDF files will be copied
        Dim destinationFolder As String = Config.configObj.HelpDocDir

        If Not destinationFolder = sourceFolder Then
            ...
            Dim pdfFiles As String() = IO.Directory.GetFiles(sourceFolder, "*.pdf")
            ...
            For Each pdfFile As String In pdfFiles
                ...
                Dim destinationFilePath As String = IO.Path.Combine(destinationFolder, fileName)

                ' Copy the file and replace if it already exists
                IO.File.Copy(pdfFile, destinationFilePath, True)
            Next
        End If
