...
Public Class Config
    ...
    '11th october 2024
    Public HelpDocDir As String = AppDomain.CurrentDomain.BaseDirectory + "Help"                     'C : \Program Files (x86)\Technosoft\BEC Automation\Help
    ...
    Sub New(ByVal configFilePath As String)
        ...
        Catch ex As Exception
            ...
            CustomLogUtil.Log("Error in configuration Read", ex.Message, ex.StackTrace)
        End Try
    End Sub
    ...
    Protected Overrides Sub ChangeConfig2()
        ...
        Else
            ...
            Dim result As DialogResult = MessageBox.Show("Do You Want to Change Config File ?" + vbNewLine + vbNewLine + "Configuration Path :" + configFilePath, "Message", MessageBoxButtons.YesNo)
    ...
    Protected Overrides Sub saveConfig2()
        ...
        '11th oct 2024
        'HelpDocumentDirectory
        Dim HelpDocumentDirectoryElement As Xml.XmlElement = doc.CreateElement("HelpDocumentDirectory")
        rootElement.AppendChild(HelpDocumentDirectoryElement)
        HelpDocumentDirectoryElement.InnerText = HelpDocDir.ToString
        doc.AppendChild(rootElement)
    ...
    Protected Overrides Sub readConfig2()
        ...
        '11th october 2024
        'HelpDocumentDirectory
        Dim HelpDocumentDirectoryElement As XmlNodeList = doc.GetElementsByTagName("HelpDocumentDirectory")
        If Not HelpDocumentDirectoryElement.Count = 0 Then
            If Not HelpDocumentDirectoryElement.ItemOf(0).InnerText = Nothing Then
                HelpDocDir = HelpDocumentDirectoryElement.ItemOf(0).InnerText
            End If
        End If
    End Sub
