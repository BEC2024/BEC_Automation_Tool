...
Public Class MTC_MTR_ExcelUtil
    ...
    ''' <param name="mtcMtrModelObj"></param>
    ''' 
    Public Sub SaveAsMTCExcelPartDoc(ByVal mtcMtrModelObj As MTC_MTR_Model, MTC_Author_Name As String, PartType As String)

        Try
            Dim xlApp As Application
            Dim xlWorkBook As Workbook
            Dim xlWorkSheetPartDoc As Worksheet
            xlApp = New Application
            Dim mtcExcelPath As String = Config.configObj.MTCExcelPath
            xlWorkBook = xlApp.Workbooks.Open(mtcExcelPath)

            If PartType = "BASELINE" Then
                xlWorkSheetPartDoc = xlWorkBook.Worksheets("Baseline")
                CenterTextInWorksheet(xlWorkSheetPartDoc)
                SetBaseLineWorkSheet_MTC(xlWorkSheetPartDoc, mtcMtrModelObj.mtcBaseLineList_BEC, mtcMtrModelObj.mtcBaseLineList_DGS, MTC_Author_Name)
                xlWorkSheetPartDoc.Columns.AutoFit()
                xlWorkSheetPartDoc.Activate()
            ElseIf PartType = "ELECTRICAL" Then
                xlWorkSheetPartDoc = xlWorkBook.Worksheets("Electrical")
                CenterTextInWorksheet(xlWorkSheetPartDoc)
                SetElectricalPartWorkSheet_MTC(xlWorkSheetPartDoc, mtcMtrModelObj.mtcElectricalPartList_BEC, mtcMtrModelObj.mtcElectricalPartList_DGS, MTC_Author_Name)
                xlWorkSheetPartDoc.Columns.AutoFit()
                xlWorkSheetPartDoc.Activate()
            ElseIf PartType = "PART" Then
                xlWorkSheetPartDoc = xlWorkBook.Worksheets("Part")
                CenterTextInWorksheet(xlWorkSheetPartDoc)
                SetPartWorkSheet_MTC(xlWorkSheetPartDoc, mtcMtrModelObj.mtcPartList_BEC, mtcMtrModelObj.mtcPartList_DGS, MTC_Author_Name)
                xlWorkSheetPartDoc.Columns.AutoFit()
                xlWorkSheetPartDoc.Activate()
            End If
    ...
    Private Sub SetSheetMetalWorkSheet_MTC(ByRef xlWorkSheet As Worksheet, ByVal finalPartListBEC As List(Of MTC_SheetMetal), ByVal finalPartListDGS As List(Of MTC_SheetMetal), MTC_Author_Name As String)
        ...
        '8th Nov 2024
        'xlWorkSheet.Cells.Validation.Delete()
        ...
        For Each mTCReviewObj As MTC_SheetMetal In finalPartListBEC
            ...
            xlWorkSheet.Cells(cnt + 2, excelcol) = mTCReviewObj.partNumber
            'xlWorkSheet.Cells(cnt + 2, excelcol) = mTCReviewObj.partNumber
            xlWorkSheet.Cells(cnt + 2, excelcol).AddComment("Part Number:" + mTCReviewObj.documentNumber)
            If (mTCReviewObj.partNumber = "No") Then
                xlWorkSheet.Cells(cnt + 2, excelcol).Interior.Color = colorRed
            End If
            ...
            If (mTCReviewObj.documentNumberCorrect = "No") Then
            ...
            '26th Oct 2024
            xlWorkSheet.Cells(cnt, excelcol).Interior.Color = System.Drawing.Color.FromArgb(165, 165, 165)
            xlWorkSheet.Cells(cnt, excelcol).font.Color = System.Drawing.Color.White
            xlWorkSheet.Cells(cnt, excelcol).font.Bold = True
            xlWorkSheet.Cells(cnt, excelcol) = "Remark"

            Dim bordersRemark As Borders = xlWorkSheet.Cells(cnt, excelcol).Borders
            bordersRemark.LineStyle = XlLineStyle.xlContinuous
            bordersRemark.Weight = 2D

            SetRemarkColumnColor(xlWorkSheet, 24, excelcol)
        ...
        For Each mTCReviewObj As MTC_SheetMetal In finalPartListDGS
            ...
            ''2
            'xlWorkSheet.Cells(cnt + 2, excelcol) = mTCReviewObj.documentNumber
            'xlWorkSheet.Cells(cnt + 2, excelcol).AddComment("Part Number:" + mTCReviewObj.documentNumber)
...
#End Region
            ...
            '2nd Dec 2024
            '1. Is the part number match with M2M? *   
            'xlWorkSheet.Cells(cnt + 1, excelcol) = mTCReviewObj.documentNumber
            xlWorkSheet.Cells(cnt + 1, excelcol) = mTCReviewObj.isPartFound
            xlWorkSheet.Cells(cnt + 1, excelcol).AddComment("Part Number:" + mTCReviewObj.documentNumber)
            If (mTCReviewObj.isPartFound = "No") Then
                xlWorkSheet.Cells(cnt + 1, excelcol).Interior.Color = colorRed
            End If
            ...
            xlWorkSheet.Cells(cnt + 10, excelcol) = mTCReviewObj.isMaterialDesc_Title
            xlWorkSheet.Cells(cnt + 10, excelcol).AddComment("Title:" + mTCReviewObj.title)
            If (mTCReviewObj.isMaterialDesc_Title = "No") Then
                xlWorkSheet.Cells(cnt + 10, excelcol).Interior.Color = colorRed
            End If
            ...
            If (mTCReviewObj.isCorrectDocumentNumber = "No") Then
                xlWorkSheet.Cells(cnt + 12, excelcol).Interior.Color = colorRed
            End If
            ...
            If (mTCReviewObj.hasSESimplifiedFeature = "Yes") Then
                xlWorkSheet.Cells(cnt + 24, excelcol).Interior.Color = colorRed
            ElseIf (mTCReviewObj.hasSESimplifiedFeature = "") Or (mTCReviewObj.hasSESimplifiedFeature = String.Empty) Or (mTCReviewObj.hasSESimplifiedFeature = Nothing) Then
                xlWorkSheet.Cells(cnt + 24, excelcol) = "No"
            End If
            ...
            SetRemarkColumnColor(xlWorkSheet, 42, excelcol)
...
#End Region
    ...
    Private Sub SetElectricalPartWorkSheet_MTC(ByRef xlWorkSheet As Worksheet, ByVal finalPartListBEC As List(Of MTC_Electrical), ByVal finalPartListDGS As List(Of MTC_Electrical), MTC_Author_Name As String)
        ...
        For Each mTCReviewObj As MTC_Electrical In finalPartListBEC
            ...
            SetRemarkColumnColor(xlWorkSheet, 11, excelcol)
    ...
    Private Sub SetPartWorkSheet_MTC(ByRef xlWorkSheet As Worksheet, ByVal finalAssemblyListBEC As List(Of MTC_Part), ByVal finalAssemblyListDGS As List(Of MTC_Part), MTC_Author_Name As String)
        ...
        For Each mTCReviewObj As MTC_Part In finalAssemblyListBEC
            ...
            'xlWorkSheet.Cells(cnt + 2, excelcol) = mTCReviewObj.documentNumber
            xlWorkSheet.Cells(cnt + 2, excelcol) = mTCReviewObj.partNumber
            If (mTCReviewObj.partNumber = "Yes") Then
                xlWorkSheet.Cells(cnt + 2, excelcol).AddComment("Part Number:" + mTCReviewObj.documentNumber)
            Else
                xlWorkSheet.Cells(cnt + 2, excelcol).AddComment("Part Number:" + mTCReviewObj.documentNumber)
                xlWorkSheet.Cells(cnt + 2, excelcol).Interior.Color = colorRed
            ...
            SetRemarkColumnColor(xlWorkSheet, 22, excelcol)
        ...
        For Each mTCReviewObj As MTC_Part In finalAssemblyListDGS
            ...
            '8. Document Number correct
            'Use the mTCReviewObj.partNumber for the DocumentNumberCorrect
            xlWorkSheet.Cells(cnt + 8, excelcol) = mTCReviewObj.documentNumberCorrect
            If mTCReviewObj.documentNumberCorrect = "Yes" Then
                xlWorkSheet.Cells(cnt + 8, excelcol).AddComment("Document Number:" + mTCReviewObj.documentNumber)
            Else
    ...
    Private Sub SetAssemblyWorkSheet_MTC(ByRef xlWorkSheet As Worksheet, ByVal finalAssemblyListBEC As List(Of MTC_Assembly), ByVal finalAssemblyListDGS As List(Of MTC_Assembly), MTC_Author_Name As String)
        ...
        For Each mTCReviewObj As MTC_Assembly In finalAssemblyListBEC
            ...
            xlWorkSheet.Cells(cnt + 2, excelcol) = mTCReviewObj.partNumber
            If (mTCReviewObj.partNumber = "Yes") Then
                xlWorkSheet.Cells(cnt + 2, excelcol).AddComment("M2M Part Number:" + mTCReviewObj.documentNumber)
                'xlWorkSheet.Cells(cnt + 2, excelcol).AddComment("Part Number:" + mTCReviewObj.assemblyName)
            Else
                xlWorkSheet.Cells(cnt + 2, excelcol).AddComment("M2M Part Number:" + mTCReviewObj.documentNumber)
                'xlWorkSheet.Cells(cnt + 2, excelcol).AddComment("Part Number:" + mTCReviewObj.assemblyName)
            ...
            SetRemarkColumnColor(xlWorkSheet, 23, excelcol)
...
#End Region
        ...
        Try
            ...
            For index = 1 To maxRowCnt
                Try
                    ...
                    ' Determine the color based on column grouping (every three columns)

                    If ((excelcol - 1) \ 3) Mod 2 = 0 Then
                        excelRange.Interior.Color = color1  'colorToUse = color1
                    Else
                        excelRange.Interior.Color = color2 'colorToUse = color2
                    End If
                    ...
                    ' Add a drop-down list (data validation) with "YES, NO"
    ...
    '26th Sep 2024
    Private Sub SetRemarkColumnColor(ByRef xlWorkSheet As Worksheet, ByVal maxRowCnt As Integer, ByVal excelcol As Integer)
        Try
            Dim rowCount As Integer = 3
            ...
            Next
        Catch ex As Exception
            MsgBox("Error to set column color: " + ex.Message + vbNewLine + ex.StackTrace)
        End Try
    End Sub
