                ...
                For Each prop1 As [Property] In custProps
                    ...
                    Try
                        ...
                        If (prop1.Name = "Title") Then
                            ...
                            Dim TitleValue As String = prop1.Value.ToString()
...
#End Region
    ...
    Private Function GetMainAssemblyDoc(ByVal mtcMtrModelObj As MTC_MTR_Model, ByVal mainAssemblyDocModel As Object, ByVal documentNo As String) As MTC_MTR_Model
        '9th Sep 2024 
        Try
            ...
            Dim filter As String = $"Convert([{partno}], 'System.String') = '{documentNo}'"
    ...
    '17th Sep 2024
    Private Function GetMainPartDoc(ByVal mtcMtrModelObj As MTC_MTR_Model, ByVal mainPartDocModel As Object, ByVal documentNo As String) As MTC_MTR_Model
        '9th Sep 2024 
        Try
            Dim dv As New DataView(mtcMtrModelObj.dtM2M)
    ...
    '28th Nov 2024
    Private Function GetMainSheetMetalDoc(ByVal mtcMtrModelObj As MTC_MTR_Model, ByVal mainSheetMetalDocModel As Object, ByVal documentNo As String) As MTC_MTR_Model
        '9th Sep 2024 
        Try
            Dim dv As New DataView(mtcMtrModelObj.dtM2M)
    ...
    Private Sub BtnExportMTC_MTR_Report_Click(sender As Object, e As EventArgs) Handles BtnExportMTC_MTR_RoutingSeq_Report.Click
        ...
        Try
            ...
            If activeDocument.Application.ActiveEnvironment.ToLower = "assembly" Then
                ...
                '28th Nov 2024
                Dim ActiveModelProperties As New List(Of DocumentModel)
                ActiveModelProperties.Add(mainAssemblyDocModel)
                Dim documentNumber As String = Nothing
                For Each ActiveModelProp As DocumentModel In ActiveModelProperties
                    documentNumber = ActiveModelProp.documentno
                Next
                ...
                mtcMtrModelObj = GetMainAssemblyDoc(mtcMtrModelObj, mainAssemblyDocModel, documentNumber)
...
#End Region
            ...
            ElseIf activeDocument.Application.ActiveEnvironment.ToLower = "part" Then
                ...
                '28th Nov 2024
                Dim ActiveModelProperties As New List(Of DocumentModel)
                ActiveModelProperties.Add(mainPartDocModel)
                Dim documentNumber As String = Nothing
                For Each ActiveModelProp As DocumentModel In ActiveModelProperties
                    documentNumber = ActiveModelProp.documentno
                Next
                ...
                mtcMtrModelObj = GetMainPartDoc(mtcMtrModelObj, mainPartDocModel, documentNumber)
                ...
                PartType = GetPartDocType(mtcMtrModelObj, PartType)
                ...
                mtcMtrExcelObj.SaveAsMTCExcelPartDoc(mtcMtrModelObj, MTC_Author_Name, PartType)
            ...
            ElseIf activeDocument.Application.ActiveEnvironment.ToLower = "sheetmetal" Then
                ...
                '28th Nov 2024
                Dim ActiveModelProperties As New List(Of DocumentModel)
                ActiveModelProperties.Add(mainSheetMetalDocModel)
                Dim documentNumber As String = Nothing
                For Each ActiveModelProp As DocumentModel In ActiveModelProperties
                    documentNumber = ActiveModelProp.documentno
                Next
                ...
                mtcMtrModelObj = GetMainSheetMetalDoc(mtcMtrModelObj, mainSheetMetalDocModel, documentNumber)
...
#End Region
    ...
    '        '19th Nov 2024
    '        'mtcMTRModelObj = GetBECReportData(mtcMTRModelObj)
    '        mtcMTRModelObj = GetBECReportDataPartDoc(mtcMTRModelObj)


    '        'DGS
    '        '19th Nov 2024
    '        'mtcMTRModelObj = GetNonBECReportData(mtcMTRModelObj)
    '        mtcMTRModelObj = GetNonBECReportDataPartDoc(mtcMTRModelObj)
    ...
    '21st Nov 2024
    Private Function GetPartDocType(ByVal mtcMTRModelObj As MTC_MTR_Model, ByVal PartDocType As String) As String

        Try
            Dim MaterialUsed As String = Nothing
            ...
            For Each dr As DataRow In mtcMTRModelObj.dtBECAuthorAssemblyData.Rows
                ...
                If dr("Material Used") IsNot Nothing Or dr("MATL SPEC") IsNot Nothing Then
                    MaterialUsed = dr("Material Used").ToString()
                End If

                If MaterialUsed.ToUpper() = "PURCHASED" Then
                    PartDocType = "BASELINE"
                ElseIf Category.ToUpper() = "ELECTRICAL" Then
                    PartDocType = "ELECTRICAL"
                Else
                    PartDocType = "PART"
                End If
    ...
    Private Function GetBECReportData(ByVal mtcMtrModelObj As MTC_MTR_Model) As MTC_MTR_Model
        Try
            ...
            For Each dr As DataRow In mtcMtrModelObj.dtBECAuthorAssemblyData.Rows
                ...
                dv.RowFilter = $"{partno}='{mtcReviewObj.documentno }'"
    ...
    '19th Nov 2024
    Private Function GetBECReportDataPartDoc(ByVal mtcMtrModelObj As MTC_MTR_Model) As MTC_MTR_Model
        Try
    ...
    '19th Nov 2024
    Private Function GetNonBECReportDataPartDoc(ByVal mtcMtrModelObj As MTC_MTR_Model) As MTC_MTR_Model
        Try
            Dim lstCompletedFileName As New List(Of String)()
    ...
    Private Function GetMTCAssembly(ByVal mtcReviewObj As DocumentModel,
        ...
        Try
            ...
            mtcAssemblyObj.partNumber = If(m2MDataObj.M2Mpartno.Trim() = mtcReviewObj.documentno.Trim(), "Yes", "No")
            ...
            mtcAssemblyObj.documentNumberCorrect = mtcAssemblyObj.partNumber 'If((mtcReviewObj.fileNameWithoutExt.Contains(mtcReviewObj.documentno)), "Yes", "No")
    ...
    Private Function GetMTCSheetMetal(ByVal mtcReviewObj As DocumentModel,
        ...
        mtcSheetMetalObj.partNumber = If(m2MDataObj.M2Mpartno.Trim() = mtcReviewObj.documentno.Trim(), "Yes", "No")
        ...
        mtcSheetMetalObj.documentNumberCorrect = mtcSheetMetalObj.partNumber ' If(mtcReviewObj.fileNameWithoutExt.Contains(mtcReviewObj.documentno), "Yes", "No")
    ...
    Private Function GetMTCPartBaseLine(ByVal mtcReviewObj As DocumentModel,
        ...
        mtcBaseLineObj.isPartFound = If(m2MDataObj.M2Mpartno.Trim() = mtcReviewObj.documentno.Trim(), "Yes", "No")
    ...
    Private Function GetMTCElectricalPart(ByVal mtcReviewObj As DocumentModel,
        ...
        mtcPartObj.partNumber = If(m2MDataObj.M2Mpartno.Trim() = mtcReviewObj.documentno.Trim(), "Yes", "No")
        ...
        mtcPartObj.documentNumberCorrect = mtcPartObj.partNumber 'If(mtcReviewObj.documentno = mtcReviewObj.fileNameWithoutExt, "Yes", "No")
...
#Region "Set Variables Data"
        ...
        If dr("Title") IsNot Nothing Then
            ...
            Dim TitleValue As String = dr("Title").ToString()
